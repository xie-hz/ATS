    ...
    <template v-else>
      <div class="recording-panel">
        ...
        <div v-if="recordStatus == 4">
          ...
          <el-button type="primary" @click="restart"><span class="iconfont icon-narrow-left"></span>继续录制</el-button>
        </div>
      </div>
    </template>
  </div>
