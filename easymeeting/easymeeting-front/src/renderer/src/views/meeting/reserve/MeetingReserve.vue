<template>
  ...
  <div class="body-content">
    ...
    <div class="form-panel">
      <el-form :model="formData" :rules="rules" ref="formDataRef" label-width="50px" @submit.prevent
        ...
        <el-form-item label="开始" prop="startTime">
          <el-date-picker v-model="formData.startTime" type="datetime" placeholder="选择开始时间" time-format="HH:mm"
            :disabled-date="disabledDate" value-format="YYYY-MM-DD HH:mm" format="YYYY-MM-DD HH:mm"
            :style="{ width: '100%' }" />
        </el-form-item>
        <!--input输入-->
    ...
    <div class="submit-btn">
      <el-button type="primary" :style="{ width: '100%' }" size="large" @click="submit">预定</el-button>
    </div>
  </div>
</template>
